 ...
 *  Wildcats age, move, eat mice, and die.
 *
 * @author Zahra Amaan and Imaan Ghafur
 */
public class WildCat extends Animal 
{
    //probability of the wildcat getting the disease
     ...
     */
    public WildCat(boolean randomAge, Field field, Location location, Time time)
    {
    ...
    /**
     * This is what the wildcat does most of the time: it hunts for
    ...
    {
        // New wildcats are born into adjacent locations.
        ...
        if(isFemale()){
            ...
            for(int b = 0; b < births && free.size() > 0; b++) {
                ...
                Animal young = new WildCat(false, field, loc,t);
    ...
    private boolean canBreed()
    {
        ...
        while(it.hasNext()) {
            Location where = it.next();
            Object animal = field.getObjectAt(where);
            if((age >= BREEDING_AGE) && animal instanceof WildCat) {
                WildCat w = (WildCat)animal;
                if(!w.isFemale()){
                    return true;
                }
            }
