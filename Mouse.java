 ...
 * mice age, move, eat grass, and die.
 *
 * @author Zahra Amaan and Imaan Ghafur
 */
public class Mouse extends Animal
{
    //probability of the mouse getting the disease
    public double diseaseProb = 0.01;
    private Time t;
    // maximum litter size
    protected static final int MAX_LITTER_SIZE = 20;
    
    /**
     * Create a mouse. A mosue can be created as a new born (age zero
     ...
     */
    public Mouse(boolean randomAge, Field field, Location location, Time time)
    {
    ...
    /**
     * This is what the mouse does most of the time: it eats grass
    ...
    /**
     * returns the probability of mouse getting the disease
     */
    ...
    private void giveBirth(List<Living> newAnimals)
    {
        ...
        if(isFemale()){
            ...
            for(int b = 0; b < births && free.size() > 0; b++) {
                ...
                Animal young = new Mouse(false, field, loc,t);
    ...
    private boolean canBreed()
    {
        ...
        while(it.hasNext()) {
            Location where = it.next();
            Object animal = field.getObjectAt(where);
            if((age >= BREEDING_AGE) && animal instanceof Mouse) {
